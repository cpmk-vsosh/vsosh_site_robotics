...
draft: false
author: "Admin"
slug: "streamfinduntil"
url: "/uchastnikam/metodika/arduino-reference/functions/communication/stream/streamfinduntil/"
type: "arduino-reference"
translationKey: "streamfinduntil"
---
**Description**

`findUntil()` reads data from the stream until the target string of given length or terminator string is found, or it times out (see [Stream.setTimeout()](../streamsettimeout)).
