...
draft: false
author: "Admin"
slug: "streamreadbytes"
url: "/uchastnikam/metodika/arduino-reference/functions/communication/stream/streamreadbytes/"
type: "arduino-reference"
translationKey: "streamreadbytes"
---
**Description**

`readBytes()` read characters from a stream into a buffer. The function terminates if the determined length has been read, or it times out (see [setTimeout()](../streamsettimeout)).
