...
author: "Admin"
slug: "serialprint"
url: "/uchastnikam/metodika/arduino-reference/functions/communication/serial/serialprint/"
type: "arduino-reference"
translationKey: "serialprint"
---
**Description**
...
You can pass flash-memory based strings to `Serial.print()` by wrapping them with [F()](../../../../variables/utilities/progmem). For example:

`Serial.print(F("Hello World"))`

To send data without conversion to its representation as characters, use [Serial.write()](../write).
...
For information on the asyncronicity of `Serial.print()`, see the Notes and Warnings section of the [Serial.write() reference page](../write#howtouse).
