...
author: "Admin"
slug: "serialevent"
url: "/uchastnikam/metodika/arduino-reference/functions/communication/serial/serialevent/"
type: "arduino-reference"
translationKey: "serialevent"
---
**Description**

Called at the end of [`loop()`](../../../../structure/sketch/loop) when data is available. Use `Serial.read()` to capture this data.
...
Instead, you can use the [`available()`](../available) method. Examples in this page demonstrates how to read serial data only when it is available, similarly to how `Serial.event()` is implemented.
