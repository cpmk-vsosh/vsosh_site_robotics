...
slug: "pulseinlong"
url: "/uchastnikam/metodika/arduino-reference/functions/advanced-io/pulseinlong/"
type: "arduino-reference"
translationKey: "pulseinlong"
---
**Description**

`pulseInLong()` is an alternative to [pulseIn()](../pulsein) which is better at handling long pulse and interrupt affected scenarios.
...
`value`: type of pulse to read: either [HIGH](../../../variables/constants/highlow/) or [LOW](../../../variables/constants/highlow/). Allowed data types: `int`.\
...
This function relies on `micros()` so cannot be used in [noInterrupts()](../../interrupts/nointerrupts) context.
