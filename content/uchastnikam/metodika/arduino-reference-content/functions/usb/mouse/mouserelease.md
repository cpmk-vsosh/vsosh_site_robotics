...
author: "Admin"
slug: "mouserelease"
url: "/uchastnikam/metodika/arduino-reference/functions/usb/mouse/mouserelease/"
type: "arduino-reference"
translationKey: "mouserelease"
---
**Description**

Sends a message that a previously pressed button (invoked through [Mouse.press()](../mousepress)) is released. `Mouse.release()` defaults to the left button.
