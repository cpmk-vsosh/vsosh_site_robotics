...
author: "Admin"
slug: "mousemove"
url: "/uchastnikam/metodika/arduino-reference/functions/usb/mouse/mousemove/"
type: "arduino-reference"
translationKey: "mousemove"
---
**Description**

Moves the cursor on a connected computer. The motion onscreen is always relative to the cursor’s current location. Before using `Mouse.move()` you must call [Mouse.begin()](../mousebegin)
