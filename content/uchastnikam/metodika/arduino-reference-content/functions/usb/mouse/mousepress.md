...
author: "Admin"
slug: "mousepress"
url: "/uchastnikam/metodika/arduino-reference/functions/usb/mouse/mousepress/"
type: "arduino-reference"
translationKey: "mousepress"
---
**Description**

Sends a button press to a connected computer. A press is the equivalent of clicking and continuously holding the mouse button. A press is cancelled with [Mouse.release()](../mouserelease).

Before using `Mouse.press()`, you need to start communication with [Mouse.begin()](../mousebegin).
