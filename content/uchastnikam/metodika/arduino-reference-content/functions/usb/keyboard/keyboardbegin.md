...
author: "Admin"
slug: "keyboardbegin"
url: "/uchastnikam/metodika/arduino-reference/functions/usb/keyboard/keyboardbegin/"
type: "arduino-reference"
translationKey: "keyboardbegin"
---
**Description**

When used with a Leonardo or Due board, `Keyboard.begin()` starts emulating a keyboard connected to a computer. To end control, use [Keyboard.end()](../keyboardend).
