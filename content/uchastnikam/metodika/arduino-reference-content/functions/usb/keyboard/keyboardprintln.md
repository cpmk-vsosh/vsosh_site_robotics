...
draft: false
author: "Admin"
slug: "keyboardprintln"
url: "/uchastnikam/metodika/arduino-reference/functions/usb/keyboard/keyboardprintln/"
type: "arduino-reference"
translationKey: "keyboardprintln"
---
**Description**

Sends one or more keystrokes to a connected computer, followed by a keystroke on the Enter key.

`Keyboard.println()` must be called after initiating [Keyboard.begin()](../keyboardbegin).
