...
draft: false
author: "Admin"
slug: "keyboard-modifiers-and-special-keys"
url: "/uchastnikam/metodika/arduino-reference/functions/usb/keyboard/keyboard-modifiers-and-special-keys/"
type: "arduino-reference"
translationKey: "keyboard-modifiers-and-special-keys"
---
**Description**
...
Note that, in order to press multiple keys simultaneously, one has to use [`Keyboard.press()`](../keyboardpress) rather than [`Keyboard.write()`](../keyboardwrite), as the latter just “hits” the keys (it presses and immediately releases them).
...
Some national layouts define extra keys. For example, the Swedish and Danish layouts define `KEY_A_RING` as `0xB7`, which is the key to the right of “P”, labeled “Å” on those layouts and “{”/“\[” on the US layout. In order to use those definitions, one has to include the proper Keyboard\_\*.h file. For example:
...
For the list of layout-specific key definitions, see the respective Keyboard\_\*.h file within the library sources.
