...
slug: "for"
url: "/uchastnikam/metodika/arduino-reference/structure/control-structure/for/"
...
`increment`: executed each time through the loop when `condition` is [`true`](../../../variables/constants/truefalse).
