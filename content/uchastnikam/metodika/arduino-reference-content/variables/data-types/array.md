...
slug: "array"
url: "/uchastnikam/metodika/arduino-reference/variables/data-types/array/"
...
For a complete program that demonstrates the use of arrays, see the ([How to Use Arrays example](https://docs.arduino.cc/built-in-examples/control-structures/Arrays)) from the ([Built-in Examples](https://docs.arduino.cc/built-in-examples)).
